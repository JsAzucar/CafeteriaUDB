...
import com.sugardaddy.cafeteriaudb.ui.platillos.PlatillosActivity
...
class InicioActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Referenciar botones
        val botonDesayuno: Button = findViewById(R.id.boton_desayuno)
        val botonAlmuerzo: Button = findViewById(R.id.boton_almuerzo)
        val botonCena: Button = findViewById(R.id.boton_cena)

        // Acciones al hacer clic
        botonDesayuno.setOnClickListener {
            abrirPantallaPlatillos("Desayuno")
        }

        botonAlmuerzo.setOnClickListener {
            abrirPantallaPlatillos("Almuerzo")
        }

        botonCena.setOnClickListener {
            abrirPantallaPlatillos("Cena")
        }
    }

    private fun abrirPantallaPlatillos(tiempoComida: String) {
        val intent = Intent(this, PlatillosActivity::class.java)
        intent.putExtra("TIEMPO_COMIDA", tiempoComida)
